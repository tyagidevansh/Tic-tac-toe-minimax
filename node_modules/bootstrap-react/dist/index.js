...
const Carousel = React.forwardRef((_a, ref) => {
    ...
    return (React__default.createElement("div", { className: `carousel ${className}`, ref: ref, onKeyDown: handleKeyDown },
        ...
        controls && (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("a", { className: "carousel-control-prev", href: "#", role: "button", onClick: prev },
            ...
            React__default.createElement("a", { className: "carousel-control-next", href: "#", role: "button", onClick: next },
...
const Collapse = React.forwardRef(({ visible, className = "", children }, ref) => {
    return (React__default.createElement(motion.div, { ref: ref, key: "content", initial: false, animate: visible ? "open" : "collapsed", "aria-expanded": visible, exit: "collapsed", variants: {
            open: {
                opacity: 1,
                height: "auto",
...
const Dropdown = React.forwardRef((_a, forwardedRef) => {
    ...
    const toggleProps = Object.assign({ id, "aria-haspopup": true, "aria-expanded": visible, ref: toggleRef }, trig
        .map((t) => triggers[t])
        .reduce((obj, item) => {
        for (let i in item)
            obj[i] = item[i];
    ...
    const handleKeyDown = React.useCallback((e) => {
        ...
        const items = dropdownRef.current
            ? Array.prototype.slice
                .call(dropdownRef.current.querySelectorAll(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)"))
                .filter((element) => {
                if (element &&
                    element.style &&
                    element.parentNode &&
    ...
    return (React__default.createElement("div", Object.assign({ ref: ref }, props, { className: `dropdown ${variant} ${dropDirection} ${className}`, onKeyDown: handleKeyDown }),
        action,
        toggler(toggleProps),
...
const Modal = React.forwardRef(({ className = "", visible, children, transition = "tween", onDismiss, scrollable = false, alignment = "top", animationVariants, }, forwardedRef) => {
    const [prevFocusedEl, setPrevFocusedEl] = React.useState();
    ...
    const handleKeyDown = React.useCallback((e) => {
        ...
        const focusableElements = modalRef.current
            ? Array.prototype.slice.call(modalRef.current.querySelectorAll("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex]"))
            : [];
        if (e.key === "Tab") {
    ...
    return (React__default.createElement(AnimatePresence, null,
        ...
        visible && (React__default.createElement(motion.div, { ref: ref, onClick: onDismiss, onKeyDown: handleKeyDown, "aria-modal": true, key: "modal", initial: "hidden", animate: "visible", exit: "hidden", variants: animationVariants || {
                hidden: {
                    opacity: 0,
